...
@Service
public class AnnualLeaveApplicationService {
    ...
    public AnnualLeaveApplicationService(EmployeeRepository employeeRepository, LeaveApplicationRepository leaveApplicationRepository, LeaveValidationService validationService){
